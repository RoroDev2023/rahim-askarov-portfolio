...
const experiences: Experience[] = [
  {
    ...
    highlights: [
      'Processed and cleaned 120,000+ medical images, implementing augmentation pipelines that reduced noise error by 22%',
      'Developed and benchmarked Transformer-based architectures and ensemble models, optimizing inference time by 30%',
      'Contributing to the development and evaluation of AI models for healthcare and clinical imaging applications',
    ],
  },
  {
